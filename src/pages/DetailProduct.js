                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 mx-lg-5 ">
                        ...
                        <div className="mb-3 mt-3">
                            ...
                            <button
                                className=" border-white bg-black rounded-circle mr-3"
                                style={{ 
                                    width: '36px', 
                                    height: '36px' 
                                }}>
                            ...
                            <button
                                className="border-white bg-danger rounded-circle mr-3"
                                style={{ 
                                    width: '36px', 
                                    height: '36px' 
                                }}>
                            </button>
                            <button className="border-white bg-primary rounded-circle mr-3"
                                style={{ 
                                    width: '36px', 
                                    height: '36px' 
                                }}>
                            </button>
                            <button className="border-white bg-success rounded-circle mr-3"
                                style={{ 
                                    width: '36px', 
                                    height: '36px' 
                                }}>
                            ...
                            <div className="d-flex ">
                                <div>
                                    ...
                                    <div className='d-flex'>
                                        ...
                                        <p>1</p>
                                        <button
                                            className=" border-white rounded-circle mr-3"
                                            style={{
                                                width: '36px',
                                                height: '36px',
                                                background: '#D4D4D4'
                        ...
                        <div className="row mt-5">
                            <Button
                                className='col-lg-3 col-4 border-secondary bg-white '
                                variant="white"
                                style={{
                                    height: '48px',
                                    borderRadius: '24px',
                            ...
                            <Button
                                className='border-secondary bg-white col-lg-3 col-4 px-2'
                                variant="white"
                                style={{
                                    height: '48px',
                                    borderRadius: '24px',
                            ...
                            <Button
                                className='bg-danger text-white col-lg-6 col-4'
                                style={{
                                    height: '48px',
                                    borderRadius: '24px',
                                    borderColor: 'white'
